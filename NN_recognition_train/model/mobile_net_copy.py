...
def model_to_train():
    ...
    x = _inverted_res_block(x, filters=120, expansion=6, stride=2,)
    x = _inverted_res_block(x, filters=60, expansion=6, stride=1, add = False)
    x = _inverted_res_block(x, filters=20, expansion=6, stride=1, add = False)
    x = _inverted_res_block(x, filters=6, expansion=6, stride=1, add = False)
